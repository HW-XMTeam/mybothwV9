...
"fileName": `THE REXJU BOTS${buttonkal}`,
...
touchmebre = [
{
title: `🌷 THE REXJU BOTS 🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
haikal.sendListMsg(m.chat, `🌷 THE REXJU BOTS 🌷`, haikal.user.name, `Hay Kak Sc Bot Adia Di List`, `Click Here 🌷`, touchmebre, m)
break
//=================================================//
case 'hu': {
if (!isCreator) return
