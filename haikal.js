...
// Base𝐃𝐢𝐤𝐳𝐲𝐲𝐲 Hw Mods : Copyan Dari Base Dika
...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC𝐃𝐢𝐤𝐳𝐲𝐲𝐲`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted: m })} 
//=================================================//
try {
...
{
"optionName": "SALAM BROTHER BY𝐃𝐢𝐤𝐳𝐲𝐲𝐲"
}
],
...
haikal.sendMessage(m.chat, {document: yy, mimetype: 'application/octet-stream', fileName:`𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️ APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
}
}
break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 haikal.sendMessage(m.chat, {document: ilih, mimetype: '', fileName:`𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️ APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
 }
 }
 break
//=================================================//
...
break
//=================================================//
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲virtext1': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️ ${iphone}` }, { quoted: doc })
}
}
break
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲virtext2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️ ${iphone1}` }, { quoted: doc })
}
}
break
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲virtext3': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️ ${iphone2}` }, { quoted: doc })
}
}
break
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲virtext4': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️ ${iphone3}` }, { quoted: doc })
}
}
break
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲virtext5': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️ ${iphone4}` }, { quoted: doc })
}
}
break
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲virtext6': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️ ${iphone5}` }, { quoted: doc })
}
}
break
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲virtext7': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️ ${iphone6}` }, { quoted: doc })
}
}
break
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲virtext8': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️ ${buttonkal}` }, { quoted: doc })
}
}
break
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲virtext9': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️ ${buttonvirus}` }, { quoted: doc })
}
}
break
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲virtext10': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️ ${ngazap(prefix)}`}, { quoted: doc })
}
}
break
//=================================================//
...
"fileName": `©𝐃𝐢𝐤𝐳𝐲𝐲𝐲${ngazap(prefix)}`,
...
"inviteExpiration": `MY NAME𝐃𝐢𝐤𝐳𝐲𝐲𝐲${ngazap(prefix)}`,
"groupName": `MY NAME𝐃𝐢𝐤𝐳𝐲𝐲𝐲${ngazap(prefix)}`,
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `©𝐃𝐢𝐤𝐳𝐲𝐲𝐲${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `©𝐃𝐢𝐤𝐳𝐲𝐲𝐲${ngazap(prefix)}`,
...
"retailerId": `©𝐃𝐢𝐤𝐳𝐲𝐲𝐲 WE ARE NOT MASTOD`,
...
"fileName": `𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️${ngazap(prefix)}`,
...
haikal.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️ ${ngazap(prefix)}.BIN`, title: `𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️ ${ngazap(prefix)}.BIN` }, { quoted: doc })
}
}
break
//=================================================//
...
ydd = `Hallo Aku haikal`
for (let i = 0; i < jumlah; i++) {
 const fkontaak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "@broadcast" } : {})}, message: { "contactMessage":{"displayName": `©𝐃𝐢𝐤𝐳𝐲𝐲𝐲${ngazap(prefix)}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️\nitem1.TEL:+6285788734756\nitem1.X-ABLabel:Celular\nitem2.EMAIL;type=INTERNET:EMAIL;CHARSET=UTF-8;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;\nEND:VCARD` }}}
...
haikal.sendMessage(m.chat, anuala, `𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command}𝐃𝐢𝐤𝐳𝐲𝐲𝐲, 7, 7, 2005, Putri, 16, 11, 2004`
...
case 'artinama': {
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command}𝐃𝐢𝐤𝐳𝐲𝐲𝐲 Gans`
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command}𝐃𝐢𝐤𝐳𝐲𝐲𝐲, 7, 7, 2005`
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command}𝐃𝐢𝐤𝐳𝐲𝐲𝐲|Putri`
...
case 'fengshui': {
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command}𝐃𝐢𝐤𝐳𝐲𝐲𝐲, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound98':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound99':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound100':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound101':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound102':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound103':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound104':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound105':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound106':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound107':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound108':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound109':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound110':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound111':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound112':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound113':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound114':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound115':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound116':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound117':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound118':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound119':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound120':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound121':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound122':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound123':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound124':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound125':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound126':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound127':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound128':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound129':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound130':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound131':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound132':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound133':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound134':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound135':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound136':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound137':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound138':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound139':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound140':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound141':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound142':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound143':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound144':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound145':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound146':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound147':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound148':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound149':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound150':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound151':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound152':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound153':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound154':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound155':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound156':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound157':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound158':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound159':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound160':
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲sound161':
 if (isBan) throw sticBanLu(from)
...
break
case '𝐃𝐢𝐤𝐳𝐲𝐲𝐲ghoib': case 'welcome': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
Base Script
©𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️
۝𝐃𝐢𝐤𝐳𝐲𝐲𝐲〽️۝`, contextInfo:{"externalAdReply": {"title": `SC𝐃𝐢𝐤𝐳𝐲𝐲𝐲`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
╚════[𝐃𝐢𝐤𝐳𝐲𝐲𝐲 ]══════⊱`,
contextInfo:{"externalAdReply": {"title": `SC𝐃𝐢𝐤𝐳𝐲𝐲𝐲`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
